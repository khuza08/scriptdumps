...
waktu = t.ctime()
print ("Generate your own KK & NIK ")
print ("[" + waktu + "]")
...
while choose:
	...
	if choose =="1":
		...
		print ("\nNIK : " + x[0])
		print ("KK  : " + x[1])
		print ("\nDone.\n"+R+"made with love by hxza\n"+W+"="*40)
		print ("Jika tidak valid, silahkan bisa re-generate\n")
		sys.exit()
	elif choose =="2":
		print ("="*40)
		print ("\nDo with your own risk\n\nNIK & KK GENERATOR v0.1\n"+R+"made with love by hxza\nthanks to 3xpl01t for help\n\n"+W+"="*40)
		t.sleep(2)
	elif choose =="3":
		break
	elif choose !="":
...
#dibuat karena gada kk sama nik yg kosong jir
